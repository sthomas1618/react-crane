...
export function filterOptions(
  options: object[],
  inputValue: string,
  parameters: FilterOptionsParameters
): object[]
...
export class Arrow<As extends React.ElementType = 'div'> extends React.Component<ArrowProps, any> {}
...
export class Clear<As extends React.ElementType = 'div'> extends React.Component<ClearProps, any> {}
...
export class FocusPlaceholder<As extends React.ElementType = 'input'> extends React.Component<
  FocusPlaceholderProps,
  any
> {}
...
export class Input<As extends React.ElementType = 'div'> extends React.Component<InputProps, any> {}
...
export class Loading<As extends React.ElementType = 'div'> extends React.Component<
  LoadingProps,
  any
> {}
...
export class Menu<As extends React.ElementType = 'div'> extends React.Component<MenuProps, any> {}
...
export class Option<As extends React.ElementType = 'div'> extends React.Component<
  OptionProps,
  any
> {}
...
export class OptionGroup<As extends React.ElementType = 'div'> extends React.Component<
  OptionGroupProps,
  any
> {}
...
export class Value<As extends React.ElementType = 'span'> extends React.Component<
  ValueProps,
  any
> {}
...
export class ValueGroup<As extends React.ElementType = 'div'> extends React.Component<
  ValueGroupProps,
  any
> {}
...
export interface SimpleSelectProps {
  ...
  onInputChange?: (
    eventContext: OnInputChangeEventContext,
    event: React.SyntheticEvent<SimpleSelect>
  ) => void
  onKeyDown?: (
    eventContext: OnChangeEventContext,
    event: React.SyntheticEvent<SimpleSelect>
  ) => void
  onOpen?: () => void
...
export interface FilterSelectProps extends SimpleSelectProps {
  filterOptions?: (
    objects: object[],
    inputValue: string,
    parameters: GetOptionLabelParameters
  ) => object[]
  ignoreCase?: boolean
...
export class SimpleSelect<As extends React.ElementType = 'div'> extends React.Component<
  SimpleSelectProps,
  any
> {}

export class SearchSelect<As extends React.ElementType = 'div'> extends React.Component<
  SimpleSelectProps,
  any
> {}

export class MultiSelect<As extends React.ElementType = 'div'> extends React.Component<
  MultiSelectProps,
  any
> {}

export class FilterSelect<As extends React.ElementType = 'div'> extends React.Component<
  FilterSelectProps,
  any
> {}
